...
OPTIONS += -D_N_MASK_INTS=2

######################

COMP = icc
OPT = -Wall -std=c++11 -qopenmp $(OPTIONS) -O3 -inline-level=2 -ipo1 -ansi-alias -align #icc
#OPT = -Wall -std=c++11 -fopenmp -D_HAVE_HDF5 -D_ANGULAR_PI_DEFN -D_USE_INV_WEIGHTS -D_N_MASK_INTS=1 #g
#INCLUDES AND LIBRARIES
INCLUDECOM = -I./src -I./src/healpix -I/opt/cray/pe/hdf5/1.10.5.2/intel/19.0/include/ 
LIB = -lm -lstdc++ -L./src -lhdf5 -L/opt/cray/pe/hdf5/1.10.5.2/intel/19.0/lib/
